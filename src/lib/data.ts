...
export const SONGS: Record<Mood, Song[]> = {
  ...
  focus: [
    {
      ...
      youtubeQuery: 'lakshya',
    },
    {
      emoji: '🎵',
      title: 'Dangal',
      artist: 'Pritam',
      youtubeQuery: 'Dangal pritam',
    },
    {
      emoji: '🎶',
      title: 'ruk jaana nahi tu kahin har zindagi',
      artist: 'Shreya Ghoshal',
      youtubeQuery: 'ruk jaana nahi tu kahin har zindagi',
    },
    {
      emoji: '🎸',
  ...
  love: [
    ...
    },
    {
      ...
      title: 'All of me',
      artist: 'John Legend',
      youtubeQuery: 'All of me',
    },
    {
      emoji: '🎙',
      title: 'Adore you',
      artist: 'Harry Styles',
      youtubeQuery: 'Adore you',
    },
  ],
};
